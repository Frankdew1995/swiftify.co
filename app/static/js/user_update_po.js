...
submitBtn.addEventListener("click", function() {
  ...
  rows.forEach(function(row) {
    var item = {
      ...
      item_name: row.querySelector(".item-input").textContent,
      barcode: row.querySelector(".barcode-input").textContent,
  ...
  var poData = {
    ...
    poUUID: document.querySelector("#poUUID").value,
    order_date: document.querySelector("#poDate").value,
    warehouse_notes: document.querySelector("#warehouseNotes").value,
    supplier_notes: document.querySelector("#supplierNotes").value,
  ...
  const response = await fetch('/api/purchase_order/update', {
    method: 'POST',
    headers: {
